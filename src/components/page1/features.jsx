...
const Features = () => {
    ...
    <div>
        <div>
            ...
            <h1 className='font-black text-2xl mt-20 mx-40 my-10 absolute '>Emergency Contact </h1>
            <h1 className='font-black text-2xl pt-10 mx-60 my-20 absolute text-purple-800'> Section</h1>
            </div>
        </div>

        <div className='wrapper my-12 ml-10 mr-24 pl-96 pr-40 drop-shadow-2xl'>
        <Slider
            width="250px"
            duration={40}
            blurBorders={false}
